...
extension Job {
    ...
    fileprivate init(row: Row) {
        ...
        self.init(
            ...
            reviewerAEngine: firstNonEmpty(row.optionalString("reviewer_a_engine")) ?? AgentEngineID.opencode,
            reviewerAModelID: row.string("reviewer_a_model_id"),
            reviewerBEngine: firstNonEmpty(row.optionalString("reviewer_b_engine")) ?? AgentEngineID.opencode,
            reviewerBModelID: row.string("reviewer_b_model_id"),
            judgeEngine: firstNonEmpty(row.optionalString("judge_engine")) ?? AgentEngineID.opencode,
